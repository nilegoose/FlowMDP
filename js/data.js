...
dimensions=["1D", "2D", "3D"],
attributes=['One Numeric', 'Two Numeric', 'Three Numeric', 'Several Numeric', 'One Num, One Cat', 'One Cat, Several Num'],
...
const colorColAb=['#bdd7e7','#6baed6','#3182bd','#08519c', "#b8a0c3", "#a6747c"];
/*----------------------------------------------------------------------------------- */
